...
* @see https://v0.dev/t/4QmZxsk0nuI
            ...
            <div className="flex flex-col justify-center space-y-4">
              <div className="space-y-2">
                <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none">
                  Unlock Your Learning Potential with AI-Powered Slides
                </h1>
                <p className="max-w-[600px] text-gray-500 md:text-xl dark:text-gray-400">
                  Experience a personalized learning journey by uploading your slides, generating notes and explanations
                  with AI, and asking questions through chat or voice assistant.
                </p>
              </div>
          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                Our AI-powered platform is designed to provide personalized learning experiences that cater to your
          ...
          <div className="mx-auto grid items-start gap-8 sm:max-w-4xl sm:grid-cols-2 md:gap-12 lg:max-w-5xl lg:grid-cols-3">
            <div className="grid gap-1">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">
                Our AI generates notes and explanations tailored to your understanding, adjusting the depth and
                complexity based on your progress.
              </p>
            </div>
            <div className="grid gap-1">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">
                Get instant feedback and guidance through chat or voice assistant to help you identify and address your
            ...
            <div className="grid gap-1">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">
                Our AI creates a personalized learning plan based on your slides and input to help you achieve your
                academic goals.
              </p>
            </div>
          </div>
        ...
        <div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6 lg:gap-10">
          <div className="space-y-3">
            ...
            <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
              Hear from real students who have experienced the power of our AI-powered platform.
            </p>
          </div>
